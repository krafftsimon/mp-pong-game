...
var AppComponent = (function () {
    ...
    AppComponent.prototype.subscribeToServer = function () {
        var _this = this;
        this.gameService.getState().subscribe(function (data) { return _this.gameState = data[_this.roomNum - 1]; }, function (error) { return console.log(error); }, function () { return console.log("Completed."); });
    };
    ...
    AppComponent.prototype.processUserInputs = function () {
        ...
        var input = { direction: this.direction,
